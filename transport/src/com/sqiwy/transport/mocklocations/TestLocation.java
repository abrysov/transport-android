...
public class TestLocation {
    ...
    public static class OrderComparator implements Comparator<TestLocation> {
		@Override
		public int compare(TestLocation lhs, TestLocation rhs) {
     ...
     */
    public TestLocation(String id, double latitude, double longitude, float accuracy, int order) {
    	Order = order;
        Id = id;
        Latitude = latitude;
        Longitude = longitude;
