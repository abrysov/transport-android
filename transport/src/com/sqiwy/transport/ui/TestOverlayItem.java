...
public class TestOverlayItem extends OverlayItem {
    ...
    public TestOverlayItem(Context context, Point busStop) {
        ...
        mBubbleBackground = res.getDrawable(R.drawable.bus_stop_bubble_background);
        ...
        mBubbleTextPaint.setColor(res.getColor(R.color.bus_stop_text_color));
        mBubbleTextPaint.setTypeface(sProximaRegularTypeface);
    }
